...
**The Opportunity:** Fabric Remote MCP provides a standardized, secure, cloud-hosted "socket" that allows *any* AI agent (in VS Code, Copilot, Custom) to execute Fabric operations via the open Model Context Protocol.
...
|-----------|------|-------|------------------|
| **M0** | Jan 2026 | Private Preview | Core platform with existing tools. Auth (User + SP), workspace/item CRUD, permissions. Design partner feedback. |
