...
export function createServer(): McpServer {
  ...
  registerAppTool(
    server,
    "workspace_refresh_card",
    {
      title: "Workspace Refresh Card",
      description:
        "Open an interactive Fabric-styled dashboard to view and manage dataset refreshes in a workspace. " +
    ...
    async (args: { workspaceId?: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(
    ...
    async ({ workspaceId }: { workspaceId: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(
    ...
    async ({ workspaceId, datasetId }: { workspaceId: string; datasetId: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(
    ...
    "workspace_provisioner",
    {
      ...
      description:
        "Open an interactive wizard to quickly provision a new Fabric workspace with pre-configured items " +
    ...
    async (args: { workspaceName?: string; template?: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(server, "create_workspace", {
    ...
    _meta: { ui: { resourceUri: provisionerUri, visibility: ["app"] } },
  }, async (args: { displayName: string; description?: string; capacityId?: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(server, "create_item", {
    ...
    _meta: { ui: { resourceUri: provisionerUri, visibility: ["app"] } },
  }, async (args: { workspaceId: string; displayName: string; type: string; description?: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(
    ...
    "pipeline_run_status",
    {
      ...
      description:
        "Open an interactive dashboard to monitor deployment pipeline stages, view recent deployment history, " +
    ...
    async (args: { pipelineId?: string }): Promise<CallToolResult> => {
      if (args.pipelineId) {
  ...
  registerAppTool(server, "get_pipeline_stages", {
    ...
    _meta: { ui: { resourceUri: pipelineUri, visibility: ["app"] } },
  }, async ({ pipelineId }: { pipelineId: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(server, "get_stage_items", {
    ...
    _meta: { ui: { resourceUri: pipelineUri, visibility: ["app"] } },
  }, async ({ pipelineId, stageId }: { pipelineId: string; stageId: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(server, "deploy_pipeline_stage", {
    ...
    _meta: { ui: { resourceUri: pipelineUri, visibility: ["app"] } },
  }, async (args: { pipelineId: string; sourceStageId: string; targetStageId: string; note?: string }): Promise<CallToolResult> => {
  ...
  registerAppTool(
    ...
    "empty_workspaces",
    {
      ...
      description:
        "Open a dashboard showing all Fabric workspaces that contain no items. " +
  ...
  registerAppTool(server, "ew_find_empty_workspaces", {
    ...
    const workspaces = await listWorkspaces();
    const emptyWorkspaces: typeof workspaces = [];
  ...
  registerAppTool(
    server,
    "single_admin_workspaces",
    {
      title: "Single-Admin Workspaces",
      description:
        "Open a dashboard showing Fabric workspaces that have only one admin. " +
  ...
  registerAppTool(server, "sa_find_single_admin_workspaces", {
    ...
    const workspaces = await listWorkspaces();
    const singleAdminWorkspaces: Array<{
      id: string; displayName: string; description: string; type: string;
      soleAdmin: { principal: { id: string; displayName: string; type: string }; role: string };
      totalMembers: number;
      allRoles: Array<{ principal: { id: string; displayName: string; type: string }; role: string }>;
    }> = [];
